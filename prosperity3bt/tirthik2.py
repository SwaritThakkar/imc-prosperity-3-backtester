        ...
        try:
            ...
            if "TOMATOES" in state.order_depths:
                ...
                if buy_orders and sell_orders:
                    ...
                    # ===========================
                    # LIGHT MARKET MAKING (optional but useful)
                    # ===========================
                    ...
                    if spread >= 2:
                        ...
                        if bid_price < ask_price:
                            ...
                            if buy_cap > 0:
                                orders.append(Order("TOMATOES", bid_price, min(5, buy_cap)))

                            if sell_cap > 0:
                                orders.append(Order("TOMATOES", ask_price, -min(5, sell_cap)))
